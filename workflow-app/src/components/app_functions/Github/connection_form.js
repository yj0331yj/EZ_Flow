...
const GitHubConnectionPopup = ({ onClose, onConfirm }) => {
  ...
  const handleSave = () => {
    const connectionData = {
      connectionType,
      connectionName,
      ...(connectionType === 'personal_access_token' && { personalAccessToken }),
      ...(connectionType === 'oauth_app' && showAdvancedSettings && { clientId, clientSecret }),
    };
      ...
      <div className="bg-white rounded-lg shadow-lg w-[32rem] flex flex-col">
        <div className="p-6 flex-1">
          ...
          <div className="space-y-4">
            ...
            {connectionType === 'personal_access_token' && (
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border rounded-md"
                  placeholder="Personal Access Token을 입력하세요"
                />
              </div>
            )}

            {connectionType === 'oauth_app' && (
            ...
            {connectionType === 'oauth_app' && showAdvancedSettings && (
              <>
                <div>
                  <label className="flex items-center text-sm font-medium text-gray-700 mb-1">
                    <ChevronDown size={16} className="mr-1" />
          ...
          <div className="flex items-start mt-4">
            ...
            <p className="text-gray-600 text-sm">
              GitHub 연결 생성 방법에 대한 자세한 정보는 <a href="#" className="text-purple-600 hover:underline">온라인 도움말</a>을 참조하세요.
            </p>
          </div>
        </div>
...
export default GitHubConnectionPopup;
